...
import { getLeads, logout, updateLeadStatus, getTeam, assignLead, deleteLead, deleteLeads, markSpam, restoreLead, assignLeads, deleteLeadsByDate, api } from '../services/api';
import {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            if (selectAllAcrossPages) {
                ...
                const filters = { status: filterStatus, ...dateRange, search: debouncedSearch };
